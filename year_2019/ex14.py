...
nb_time_can_rerun = int(1000000000000 / min_ore_for_one_fuel)
print(nb_time_can_rerun)

for chemical_name, chemical_amount in dict_remaining_chemicals.items():
    dict_remaining_chemicals[chemical_name] = nb_time_can_rerun * chemical_amount
dict_needed_chemicals['ORE'] *= nb_time_can_rerun

# 2. Then "revert" as many remaining chemicals as possible (except fuel, ofc). Repeat as long as you have
# reversions you can do
run_system_until_no_excess_product_remains(dict_reactions)

print(dict_remaining_chemicals['FUEL'])
print(dict_remaining_chemicals)
print(dict_needed_chemicals)
