...
# list_starting_nums = [0, 3]
list_starting_nums = [6, 19, 0, 5, 7, 13]

list_spoken_nbers = array.array('i', (-1,)*30000000)
tLess1 = time.time()

for idx, num in enumerate(list_starting_nums):
...
t0 = time.time()
print(t0 - tLess1)
for nb_spoken_nums in range(len(list_starting_nums), max_treshold - 1):
